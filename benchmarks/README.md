...
benchmarks/
  ...
  modal/
    ...
    modal_vjepa_train.py V-JEPA 2 attentive-probe benchmark (UCF101)
  train_vjepa_probe.py V-JEPA 2 frozen-backbone probe
  video_data.py        UCF101 clip loading
...
Convergence plots for every run are in [figures/](figures/), generated by
`plot_curves.py`: solid log-scale validation loss on the left axis, dashed
accuracy/mAP50-95 on the right, with a vertical marker at the peak-validation
epoch.
